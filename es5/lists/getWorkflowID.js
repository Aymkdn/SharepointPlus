...
export default function getWorkflowID(_x) {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 13:
            ...
            if (!_startsWithInstanceProperty(_context = this.url).call(_context, "http")) {
              // we need to find the full path
              fileRef = _sliceInstanceProperty(_context2 = window.location.href.split("/")).call(_context2, 0, 3).join("/") + "/" + fileRef;
            }

            if (!_startsWithInstanceProperty(fileRef).call(fileRef, "http")) {
              fileRef = _sliceInstanceProperty(_context3 = this.url.split("/")).call(_context3, 0, 3).join("/") + "/" + fileRef;
            }
          ...
          case 23:
            ...
            _context4.next = 33;
            return new _Promise(function (prom_res, prom_rej) {
