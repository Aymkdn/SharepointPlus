    ...
    */
    ...
    /**
      ...
      @param {Object} [setup] Options (see below)
        ...
        @param {Boolean} [setup.paging=false] If you have defined the 'rowlimit' then you can use 'paging' to cut by packets your full request -- this is useful when there is a list view threshold (attention: we cannot use "WHERE" and "ORDERBY" with this option)
    ...
    get:function(setup, fct) {
      ...
      if (setup.view !== "") {
        ...
        if (setup.whereCAML!==true) {
          setup.where = this.parse(setup.where, setup.whereEscapeChar);
          setup.whereCAML=true;
        }
      }
