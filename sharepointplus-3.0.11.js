...
if (!Array.prototype.indexOf) {
  ...
  */
  ...
  /* unfortunately it causes issues with Sharepoint when calling a Custom Action into a form
  // to fix it we need to change a Sharepoint thing
  function SharepointPlus_fix_getSelectedItems_init() {
    if (typeof ExecuteOrDelayUntilBodyLoaded !== "undefined") {
      ExecuteOrDelayUntilBodyLoaded(function() {
        SP.ListOperation.Selection.getSelectedItems = function() {
          var a = GetSelectedItemsNative();
          return (a.length === 0 ? {} : a)
        };
      })
    }
  ...
  if (typeof _spBodyOnLoadFunctionNames !== "undefined") {
    _spBodyOnLoadFunctionNames.push("SharepointPlus_fix_getSelectedItems_init");
  }*/
}
...
(function(window, document, undefined) {
  ...
  SharepointPlus.prototype = {
    ...
    */
   getVersion:function() { return "3.0.11" },
    /**
      @name $SP().list
      @namespace
    ...
    */
    ...
    /**
      ...
      @param {Object} [options]
        @param {Boolean} [cache=true] Do we want to use the cache on recall for this function?
    ...
    */
    ...
    /**
      ...
      @param {Object} [options]
        @param {Boolean} [cache=true] Do we use the cache?
      @param {Function} [function()] A function with the data from the request as first argument
