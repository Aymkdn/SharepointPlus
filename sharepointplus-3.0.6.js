    ...
    */
    get:function(setup, fct) {
      ...
      if (setup.queryOptions === undefined) {
        setup.queryOptions = "<DateInUtc>"+setup.dateInUTC+"</DateInUtc>"
        ...
        if (setup.folderOptions) {
          ...
          setup.queryOptions += "<ViewAttributes Scope=\""+viewAttr+"\"></ViewAttributes>"
          if (setup.folderOptions.path) setup.queryOptions += "<Folder>"+this.url + this.listID + '/' + setup.folderOptions.path+"</Folder>"
        } else
          setup.queryOptions += "<ViewAttributes Scope=\"Recursive\"></ViewAttributes>"
      }
